...
function InputNickName() {
  ...
  return (
    <div className='flex items-center justify-center w-screen h-screen'>
        <div>
            <p className='text-5xl text-center mb-7 text-ttokPink NickName'>똑켓</p>
            <div className='flex items-center justify-center h-56 p-2 border-2 border-gray-100 rounded-lg shadow-lg w-80'>
