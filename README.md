...
- 저희는 티켓팅에 수없이 실패하고 아쉬운 적이 많습니다.
- 그러던 중 보이는 암표거래 관련 글과 기사들을 보고 화가 났습니다.
- 저희 똑켓 서비스를 통해 암표가 없는 티켓서비스를 이용해보세요!
<br>

## :heavy_check_mark: TTocket - 개요
- NFT티켓을 구매하여 암표거래를 방지해보세요.
- 블록체인 기술을 이용해 대체 불가능 한 나만의 티켓을 만들고, 추억을 담아, 영구적으로 소유할 수 있는 NFT 기반 티켓팅 및 티켓 관리 서비스를 제공합니다.
<br>
